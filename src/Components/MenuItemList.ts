...
export const BreakfastItems: IMenuItem[] = [];

export const AppetizerItems: IMenuItem[] = [
  {
    id: 1,
...
export const SandwichItems: IMenuItem[] = [
  {
    id: 10,
...
export const SideItems: IMenuItem[] = [
  {
    id: 11,
...
export const BurgerItems: IMenuItem[] = [
  {
    id: 22,
...
export const PlatterItems: IMenuItem[] = [
  {
    id: 29,
...
export const ComboPlatterItems: IMenuItem[] = [
  {
    id: 34,
...
export const RonsPlatterItems: IMenuItem[] = [
  {
    id: 40,
    ItemName:
...
export const TacoItems: IMenuItem[] = [
  {
    id: 41,
    ItemName: "Carnitas",
    MenuItemType: ItemType.Lunch,
...
export const SaladMenuItems: IMenuItem[] = [
  {
    id: 51,
    ItemName: "Ceasar",
    MenuItemType: ItemType.Lunch,
...
export const SoupMenuItems: IMenuItem[] = [
  {
    id: 56,
...
export const KidMenuItems: IMenuItem[] = [
  {
    id: 57,
...
export const DessertMenuItems: IMenuItem[] = [
  {
    id: 62,
...
export const HouseSpecialityItems: IHouseSpecialityItem[] = [
  {
